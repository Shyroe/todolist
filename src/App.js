...
class App extends Component {
  ...
  componentDidMount() {
    ...
    axios.get('https://jsonplaceholder.typicode.com/todos?_limit=10') //Estou limitando a api para retornar apenas 10 objs no array data
            ...
            <div className="row">
              <div className="col-10 mx-auto col-md-8">
                ...
                <Route exact path="/" render={props => (
                  <>
                    <h3 className="text-center mt-2">Todo Input</h3>
